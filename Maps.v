...
Lemma t_update_eq : forall (A : Type) (m : total_map A) x v,
    (x !-> v ; m) x = v.
Proof.
intros. unfold t_update. cut (eqb_string x x = true).
...
Theorem t_update_neq : forall (A : Type) (m : total_map A) x1 x2 v,
    ...
    (x1 !-> v ; m) x2 = m x2.
Proof.
intros. unfold t_update. rewrite <- eqb_string_false_iff in H. rewrite H. reflexivity.
Qed.
(** [] *)
...
Lemma t_update_shadow : forall (A : Type) (m : total_map A) x v1 v2,
    (x !-> v2 ; x !-> v1 ; m) = (x !-> v2 ; m).
Proof.
intros. apply functional_extensionality. intros. unfold t_update. destruct (eqb_string x x0).
- reflexivity.
- reflexivity.
Qed.
(** [] *)
...
Theorem t_update_same : forall (A : Type) (m : total_map A) x,
    (x !-> m x ; m) = m.
Proof.
intros. apply functional_extensionality. intros. unfold t_update. destruct (eqb_stringP x x0).
...
Theorem t_update_permute : forall (A : Type) (m : total_map A)
    ...
    (x2 !-> v2 ; x1 !-> v1 ; m).
Proof.
intros. apply functional_extensionality. intros. unfold t_update. destruct (eqb_stringP x1 x).
- destruct (eqb_stringP x2 x).
  + rewrite e in H. rewrite e0 in H. exfalso. apply H. reflexivity.
  + reflexivity.
- destruct (eqb_stringP x2 x).
  + reflexivity.
  + reflexivity.

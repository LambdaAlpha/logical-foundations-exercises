...
Theorem plus_id_exercise : forall n m o : nat,
  n = m -> m = o -> n + m = m + o.
Proof.
  intros n m o E1 E2. rewrite E1. rewrite E2. reflexivity.
Qed.
(** [] *)
...
Theorem mult_S_1 : forall n m : nat,
  ...
  m * (1 + n) = m * m.
Proof.
intros n m E1. simpl. rewrite E1. reflexivity. 
Qed.
...
match m with
|Z => 0
|B m' => let n := bin_to_nat m' in n + n + 1
|A m' => let n := bin_to_nat m' in n + n
end.
...
Example test_bin_incr1: incr (A (A (B Z))) = B (A (B Z)).
Proof. reflexivity. Qed. 

Example test_bin_incr2: incr (B (A (B Z))) = A (B (B Z)).
Proof. reflexivity. Qed.

Example test_bin_to_nat: bin_to_nat (A (A (B Z))) = 4.
Proof. reflexivity. Qed.
